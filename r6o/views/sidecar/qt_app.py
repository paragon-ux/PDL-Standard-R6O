...
"""Production Qt Quick shell for the bounded H2-C feasibility phase."""
...
class QtSidecarWindow:
    ...
    def __init__(self, mode: SidecarMode = SidecarMode.STANDARD) -> None:
        ensure_application()
        self.bridge = SidecarFeasibilityBridge(mode)
        ...
        self.window = roots[0]
        self.bridge.closeRequested.connect(self.window.hide)
